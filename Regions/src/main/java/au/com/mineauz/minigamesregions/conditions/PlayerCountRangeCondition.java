...
public class PlayerCountRangeCondition extends ACondition {
    ...
    protected PlayerCountRangeCondition(final @NotNull Key key) {
        super(key);
    }

    @Override
    public @NotNull Component getDisplayName() {
        return MessageManager.getMessage(RegionLangKey.MENU_CONDITION_PLAYERCOUNTRANGE_NAME);
    }
    ...
    public @NotNull Map<@NotNull Component, @Nullable Component> describe() {
        return Map.of(MessageManager.getMessage(RegionLangKey.MENU_CONDITION_PLAYERCOUNTRANGE_NAME),
