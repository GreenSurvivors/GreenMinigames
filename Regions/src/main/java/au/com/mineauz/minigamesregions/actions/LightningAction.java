...
public class LightningAction extends AAction {
    ...
    public @NotNull Component getDisplayname() {
        return MessageManager.getMessage(RegionLangKey.MENU_ACTION_LIGHTNING_NAME);
    }
    ...
    public @NotNull Map<@NotNull Component, @Nullable Component> describe() {
        return Map.of(MessageManager.getMessage(RegionLangKey.MENU_ACTION_LIGHTNING_EFFECT_NAME), Component.text(effect.getFlag()));
    }
    ...
    public boolean displayMenu(final @NotNull Menu previous) {
        ...
        menu.addItem(effect.getMenuItem(ItemType.ENDER_PEARL, MessageManager.getMessage(RegionLangKey.MENU_ACTION_LIGHTNING_EFFECT_NAME)));
        menu.displayMenu();
        return true;
    }
}
