...
public class MinigameTimeRangeCondition extends ACondition {
    ...
    public @NotNull Component getDisplayName() {
        return MessageManager.getMessage(RegionLangKey.MENU_CONDITION_MINIGAMETIMERANGE_NAME);
    }
    ...
    public @NotNull Map<@NotNull Component, @Nullable Component> describe() {
        return Map.of(MessageManager.getMessage(RegionLangKey.MENU_CONDITION_MINIGAMETIMERANGE_NAME),
    ...
    public boolean displayMenu(final @NotNull Menu prev) {
        ...
        menu.addItem(minTime.getMenuItem(ItemType.CLOCK, MessageManager.getMessage(RegionLangKey.MENU_RANGE_MIN_NAME), 0L, null));
        menu.addItem(maxTime.getMenuItem(ItemType.CLOCK, MessageManager.getMessage(RegionLangKey.MENU_RANGE_MAX_NAME), 0L, null));
