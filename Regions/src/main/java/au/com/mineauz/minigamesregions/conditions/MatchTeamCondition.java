...
public class MatchTeamCondition extends ACondition {
    ...
    public @NotNull Component getDisplayName() {
        return MessageManager.getMessage(RegionLangKey.MENU_CONDITION_MATCHTEAM_NAME);
    }
    ...
    public @NotNull Map<@NotNull Component, @Nullable Component> describe() {
        return Map.of(MessageManager.getMessage(RegionLangKey.MENU_TEAM_NAME), teamColor.getFlag().getCompName());
    }
    ...
    public boolean displayMenu(final @NotNull Menu prev) {
        ...
        menu.addItem(new MenuItemList<>(getTeamDisplayItemType(), MessageManager.getMessage(RegionLangKey.MENU_TEAM_NAME), new Callback<TeamColor>() { // don't know why but for some reason the compiler doesn't like when I remove the redundant Teamcolor from the callback. Please let it in there for now!
            @Override
