...
public class SwapBlockAction extends AAction {
    ...
    public boolean displayMenu(@NotNull MinigamePlayer mgPlayer, Menu previous) {
        ...
        m.addItem(new MenuItemBlockData(matchType.getFlag().getMaterial(), "Match Block", new Callback<>() {
        ...
        m.addItem(new MenuItemBlockData(toType.getFlag().getMaterial(), "To Block", new Callback<>() {
