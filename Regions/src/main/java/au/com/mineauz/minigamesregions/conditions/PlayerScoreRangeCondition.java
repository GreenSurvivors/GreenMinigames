...
public class PlayerScoreRangeCondition extends ACondition {
    ...
    protected PlayerScoreRangeCondition(final @NotNull Key key) {
        super(key);
    }

    @Override
    public @NotNull Component getDisplayName() {
        return MessageManager.getMessage(RegionLangKey.MENU_CONDITION_PLAYERSCORERANGE_NAME);
    }
    ...
    public @NotNull Map<@NotNull Component, @Nullable Component> describe() {
        return Map.of(MessageManager.getMessage(RegionLangKey.MENU_CONDITION_PLAYERSCORERANGE_NAME),
    ...
    public boolean displayMenu(final @NotNull Menu prev) {
        ...
        menu.addItem(min.getMenuItem(ItemType.STONE_SLAB, MessageManager.getMessage(RegionLangKey.MENU_RANGE_MIN_NAME), 0, null));
        menu.addItem(max.getMenuItem(ItemType.STONE, MessageManager.getMessage(RegionLangKey.MENU_RANGE_MAX_NAME), 0, null));
