            ...
            if (!minigame.isSpectator(mgPlayer)) {
                ...
                if (mgPlayer.isLiving()) {
                    ...
                    if (loc != null) {
                        ...
                        Minigames.log.warning("Minigame " + minigame.getName(true) + " has no end position set! (Player: " + mgPlayer.getName() + ")");
                    }
                } else {
                    if (!isWinner) {
                        mgPlayer.setQuitPos(minigame.getQuitPosition());
                    } else {
                        mgPlayer.setQuitPos(minigame.getEndPosition());
                    }
                ...
                mgPlayer.teleport(minigame.getQuitPosition());
                mgPlayer.setStartPos(null);
                mgPlayer.removeMinigame();
                ...
                MinigameMessageManager.sendMessage(mgPlayer, MinigameMessageType.ERROR, MinigameLangKey.PLAYER_SPECTATE_QUIT_PLAYERMSG,
                        Placeholder.unparsed(PlaceHolderKey.MINIGAME.getKey(), minigame.getName(true)));
                mgManager.sendMinigameMessage(minigame, MinigameMessageManager.getMinigamesMessage(MinigameLangKey.PLAYER_SPECTATE_QUIT_MINIGAMEMSG,
                        Placeholder.unparsed(PlaceHolderKey.PLAYER.getKey(), mgPlayer.getName()),
                        Placeholder.unparsed(PlaceHolderKey.MINIGAME.getKey(), minigame.getName(true))), MinigameMessageType.ERROR, mgPlayer);
            }
