...
public class Events implements Listener {
    ...
    public void onPlayerResourcePack(@NotNull PlayerResourcePackStatusEvent event) { //todo redo with multible Ressoucepacks in mind.
    ...
    public void onPlayerDisconnect(@NotNull PlayerQuitEvent event) {
        ...
        if (mgPlayer.isInMinigame()) {
            if (mgPlayer.getPlayer().isDead()) {
                mgPlayer.getOfflineMinigamePlayer().setLoginLocation(mgPlayer.getMinigame().getQuitPosition());
    ...
    @EventHandler
    public void playerInterract(@NotNull PlayerInteractEvent event) {
        MinigamePlayer mgPlayer = pdata.getMinigamePlayer(event.getPlayer());
