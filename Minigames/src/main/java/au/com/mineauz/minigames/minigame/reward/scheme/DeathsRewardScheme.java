...
public class DeathsRewardScheme extends HierarchyRewardScheme<@NotNull Integer> {

    protected DeathsRewardScheme(final @NotNull Key key) {
        super(key);
    }
    ...
    protected @NotNull Component getMenuItemDescName(final @NotNull Integer value) {
        return MessageManager.getMessage(MgMenuLangKey.MENU_REWARD_DEATHS_DESCRIPTION,
