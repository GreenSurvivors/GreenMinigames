    ...
    public boolean signCreate(SignChangeEvent event) {
        ...
        if (TeamColor.matchColor(event.getLine(2)) != null) {
            ...
            if (TeamColor.matchColor(event.getLine(3)) != null) {
                ...
                event.getPlayer().sendMessage(ChatColor.RED + "" + ChatColor.WHITE + MinigameUtils.getLang("sign.flag.invalidSyntax") + " red, blue and neutral.");
                return false;
            }
        }
//        else{
//            event.getBlock().breakNaturally();
//            event.getPlayer().sendInfoMessage(ChatColor.RED + "" + ChatColor.WHITE + MinigameUtils.getLang("sign.flag.invalidSyntax") + " red, blue and neutral.");
//            return false;
//        }
        return true;
    }
