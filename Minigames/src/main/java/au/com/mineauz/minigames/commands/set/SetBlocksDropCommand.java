...
public class SetBlocksDropCommand extends ASetCommand {
    ...
    public @NotNull Component getDescription() {
        return MessageManager.getMessage(MgCommandLangKey.COMMAND_SET_BLOCKSDROP_DESCRIPTION);
    }

    @Override
    public @NotNull Component getUsage() {
        return MessageManager.getMessage(MgCommandLangKey.COMMAND_SET_BLOCKSDROP_USAGE);
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Minigame minigame,
        ...
        if (args != null) {
            ...
            if (bool != null) {
                ...
                MessageManager.sendMessage(sender, MinigameMessageType.SUCCESS, MgCommandLangKey.COMMAND_SET_BLOCKSDROP_SUCCESS,
