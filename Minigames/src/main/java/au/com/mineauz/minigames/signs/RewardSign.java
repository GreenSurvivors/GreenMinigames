...
public class RewardSign extends AMinigameSign {
    ...
    public @NotNull Component getName() {
        return MessageManager.getMessage(MgSignLangKey.TYPE_REWARD);
    }
    ...
    public boolean signCreate(final @NotNull SignChangeEvent event) {
        ...
        MessageManager.sendMessage(event.getPlayer(), MinigameMessageType.ERROR, MgMiscLangKey.SIGN_REWARD_ERROR_NONAME);
        return false;
    }
    ...
    public boolean signUse(final @NotNull Sign sign, final @NotNull MinigamePlayer mgPlayer) {
        ...
        if (!MinigameTool.isMinigameTool(player.getInventory().getItemInMainHand())) {
            ...
            mic.setClick(() -> {
                ...
                MessageManager.sendMessage(mic.getMenu().getIntendedViewer(), MinigameMessageType.INFO, MgMiscLangKey.SIGN_REWARD_SAVED);
