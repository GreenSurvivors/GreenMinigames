...
public class SetRegenDelayCommand extends ASetCommand {
    ...
    public @NotNull Component getDescription() {
        return MessageManager.getMessage(MgCommandLangKey.COMMAND_SET_REGENDELAY_DESCRIPTION);
    }

    @Override
    public @NotNull Component getUsage() {
        return MessageManager.getMessage(MgCommandLangKey.COMMAND_SET_REGENDELAY_USAGE);
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Minigame minigame,
        ...
        if (args != null) {
            ...
            if (millis != null) {
                ...
                MessageManager.sendMessage(sender, MinigameMessageType.SUCCESS, MgCommandLangKey.COMMAND_SET_REGENDELAY_SUCCESS,
