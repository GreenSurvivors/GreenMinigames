...
public class SetMaxPlayersCommand extends ASetCommand {
    ...
    public @NotNull Component getDescription() {
        return MessageManager.getMessage(MgCommandLangKey.COMMAND_SET_MAXPLAYERS_DESCRIPTION);
    }

    @Override
    public @NotNull Component getUsage() {
        return MessageManager.getMessage(MgCommandLangKey.COMMAND_SET_MAXPLAYERS_USAGE);
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Minigame minigame,
        ...
        if (args != null) {
            if (args[0].matches("[0-9]+")) {
                ...
                MessageManager.getMessage(MgCommandLangKey.COMMAND_SET_MAXPLAYERS_SUCCESS,
