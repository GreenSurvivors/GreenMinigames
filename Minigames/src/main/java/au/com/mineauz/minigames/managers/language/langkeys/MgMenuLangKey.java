...
public enum MgMenuLangKey implements MinigameLangKey {
    ...
    MENU_BLOCKTYPE_DESCRIPTION("menu.blocktype.description"),
    MENU_ITEMTYPE_DESCRIPTION("menu.itemtype.description"),
    ...
    MENU_TEAM_COLLIDE_ALLWAYS("menu.team.collide.always"),
    MENU_TEAM_COLLIDE_NEVER("menu.team.collide.never"),
    MENU_TEAM_COLLIDE_WITH_OTHER_TEAMS("menu.team.collide.withOtherTeams"),
    MENU_TEAM_COLLIDE_WITH_OWN_TEAM("menu.team.collide.withOwnTeam"),
    ...
    MENU_WHITELIST_ADDBLOCKTYPE_NAME("menu.whitelist.addBlockType.name"),
