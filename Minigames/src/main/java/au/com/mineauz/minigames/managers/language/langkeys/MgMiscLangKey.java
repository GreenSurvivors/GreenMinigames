...
public enum MgMiscLangKey implements MinigameLangKey { //todo this gets rather big. Slit it into smaller digestible parts: tool, ?...
    AND("and"),
    ...
    MINIGAME_ERROR_START_NOT_ENOUGH_TEAMS("minigame.error.start.notEnoughTeams"),
    ...
    SIGN_CTF_FLAG_BROKEN_SUPPORT("sign.flag.broken.support"),
    SIGN_CTF_FLAG_DESCRIPTION("sign.ctfFlag.item.description"),
    ...
    MgMiscLangKey(@NotNull String path) {
        this.path = path;
    }
